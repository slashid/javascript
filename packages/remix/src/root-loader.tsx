...
export const rootLoader = (context: RootLoaderSlashIDContext) => <T extends RootAuthLoaderCallback>(callback: T = defaultCallback) => async (args: LoaderFunctionArgs): Promise<ReturnType<T>> => {
